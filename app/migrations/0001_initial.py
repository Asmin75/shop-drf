# Generated by Django 2.2.4 on 2019-09-01 07:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Agent', 'Agent'), ('User', 'User')], default='User', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Picked', 'Picked'), ('Drop', 'On Progress'), ('Delivered', 'Delivered')], max_length=100, null=True)),
